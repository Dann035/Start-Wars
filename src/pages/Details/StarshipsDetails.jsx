...
function StarshipsDetails() {
    ...
    const fetchElement = async (id,storedData) => {
        ...
        try {
            const response = await fetch(`https://swapi.tech/api/starships/${id}`); // Cambia la URL según tu API
    ...
    return (
        <div className="containerDetails">
            <header>
                <h1 className='titleDetails'>Starships Details</h1>
            </header>
            <section className='dataInfo'>
                {loading && <p>Loading...</p>}
                <div className='imgDetails'>
                    <img className='imgDetails' src={`https://raw.githubusercontent.com/tbone849/star-wars-guide/refs/heads/master/build/assets/img/starships/${id}.jpg`} alt="" />
